...
Seninle beraber **${üyesayısı}** kişiyiz.Sunucu Özel URL tarafından davet edildin! ${hosgeldin} ${hosgeldin} ${hosgeldin} `)

channel.wsend(`${member}, sunucuya katıldı! Davet Eden: **Sunucu Özel URL** ${hosgeldin} ${hosgeldin} ${hosgeldin}`)
return }
